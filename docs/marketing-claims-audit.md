...
**Last reviewed:** `2026-06-05` (ISO 8601). This date is the anchor used by the
...
Most recent pass: Task #803 (2026-06-05) — WATCH-row re-walk. Re-verified every
...
| Claim | Source | Status | Note |
|---|---|---|---|
| `Stateless, encrypted, peer-to-peer.` | Tech overview §"Architecture" | OK | |
