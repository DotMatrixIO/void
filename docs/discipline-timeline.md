...
| 2026-05-03 | ~~`check:still-poster`~~ | Media integrity | **Retired 2026-07-14 (Task #1125).** Was a drift guard for the auto-generated still poster. The social card is now a hand-chosen screenshot that must never be auto-regenerated, so the guard and its regen pipeline were removed. |
