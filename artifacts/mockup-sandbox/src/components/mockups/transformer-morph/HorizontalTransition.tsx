...
export function HorizontalTransition() {
  ...
  const screenSlot = (
    <>
      <div style={{
        position: "absolute", inset: 0,
        transform: inCall ? "translateX(-100%)" : "translateX(0)",
      ...
      <div style={{
        position: "absolute", inset: 0,
        transform: inCall ? "translateX(0)" : "translateX(100%)",
        transition: "transform 0.48s cubic-bezier(0.4, 0, 0.2, 1)",
      }}>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        VARIANT B — HORIZONTAL<br />
        <span style={{ color: "#333" }}>LOBBY SLIDES LEFT · IN-CALL ENTERS RIGHT</span>
      </div>
