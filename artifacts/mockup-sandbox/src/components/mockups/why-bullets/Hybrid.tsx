...
// Hybrid voice: uppercase mono CLAIM in gold (scannable, linkable,
// quotable) over 1–3 sentences of Vonnegut-cadence prose. The claim
// reads like a section heading; the body reads like a paragraph from a
// book. The contrast is deliberate.
const bullets: Bullet[] = [
  ...
  {
    marker: "03",
    claim: "Six words. 66 bits of chaos. Never sent to us.",
    body: (
      <>
        ...
        send to anyone. So we don't get them. Nobody on the wire gets
        them. You say them out loud to the person you want in the room.
        This is how doors used to work.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        the year after, or ever. The past is sealed against the future.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        Video filters and voice masks run locally — in a WebGL shader and
        an audio worklet — before a single frame or sample leaves your
        machine. You can be made of gold, or pixels, or punctuation. You
        can sound like someone at the bottom of a well. You can also look
        and sound like yourself. We are not in the judging business.
      </>
    ),
  },
];
    ...
    >
      ...
      <div style={sectionStyle}>
        ...
        <p style={introStyle}>
          ...
          broken by people in suits. These cannot. They are how the thing
          is built.
        </p>
